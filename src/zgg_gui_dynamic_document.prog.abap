...
FORM create_document.
  ...
  TRY.
      ...
      gv_status = 'Native Dynamic Document created and displayed in its generated HTML control'.
...
FORM reset_document.
  ...
  TRY.
      ...
      gv_status = 'Document reset to deterministic initial content while reusing its HTML control'.
    CATCH cx_root INTO DATA(lx_error).
